...
public class ProtocolUpdatePlayerStatus implements IProtocol
{
	...
	public void Execute(Object param1, Object param2)
	{
		...
		{
			session.getPlayer().getMap().updatePlayerStatus(session.getPlayer());
		}
		else
		{
			log.error("收到的AccountId与会话中保存的AccountId不符，现有的Id=" + session.getPlayer().accountId + ", 收到的Id=" + accountId);
		}
	}
